...
- computed with [script_spa.py](script_spa.py)  
...
### UpCCGSD/STO-3G
- computed with [script_upccgsd.py](script_upccgsd.py)  
- described in [arxiv:2105.03836](https://arxiv.org/abs/2105.03836)  
- qubit count: qubits=2x(N-Electrons)

### UpCCGSD/STO-3G (Pennylane)
Including Pennylane timings (see [script_pl.py](script.py)) as a representative for industry standard state-of-the-art code.  
